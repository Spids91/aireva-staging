...

  {
    ...
    variants: [
      ...
      { cause:'right-hemisphere stroke, left-sided weakness', conscious:true, witness:'witnessed', onsetWhen:'about 40 minutes ago',
        ...
        allergies:'No known drug allergies.',
        sample:{ medications:'Eliquis for atrial fibrillation, and Tritace for blood pressure.', pmh:'Atrial fibrillation and high blood pressure.' },
      ...
      { cause:'left-hemisphere stroke, speech affected', conscious:true, witness:'witnessed', onsetWhen:'about half an hour ago',
        ...
        sample:{ medications:'Plavix, Lipitor, and Coversyl.', pmh:'A previous TIA two years ago, high cholesterol, and high blood pressure.' },
      ...
      { cause:'wake-up stroke, uncertain onset', conscious:true, witness:'witnessed', wakeUp:true,
        ...
        allergies:'No known drug allergies.',
        sample:{ medications:'A few tablets, a water tablet and something for diabetes, not sure of the names. The blister pack says Glucophage and Lasix.', pmh:'Type 2 diabetes and heart failure.' },
      ...
      { cause:'transient symptoms, resolving', conscious:true, witness:'witnessed', onsetWhen:'about half an hour ago', improving:true,
        ...
        allergies:'No known drug allergies.',
        sample:{ medications:'Xarelto and Istin.', pmh:'Atrial fibrillation and high blood pressure.' },
