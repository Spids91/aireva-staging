...
// Locations carry optional flags:
//   found    — a patient could plausibly be "found" here (vs having travelled to it)
//   solo     — a patient could plausibly be here alone (drives witnessed/unwitnessed pool)
//   setting  — coarse category, used for presentation locationBias
//   ageSkew  — 'young' | 'old' | (absent = mixed). Soft weighting via ageFactor: a 'young'
//              spot rarely holds an older patient and vice-versa.
//   noPaed   — HARD exclude for paediatric patients (age <= 12). For places a child would
//              not be: adult workplaces, licensed premises, lone outdoor/transport spots.
//              Unlike ageSkew (soft), this is a hard filter so no absurd paed dispatch occurs.
const SCEN_LOCATIONS = [
  ...
  { name:'a shopping centre',                 found:true , solo:false, setting:'public-indoor', ageSkew:'young' },
  { name:'a supermarket',                     found:true , solo:false, setting:'public-indoor', ageSkew:'young' },
  { name:'a hotel lobby',                     found:false, solo:false, setting:'public-indoor'   },
  { name:'an office',                         found:false, solo:false, setting:'public-indoor', noPaed:true },
  ...
  { name:'a pub',                             found:false, solo:false, setting:'public-indoor', noPaed:true },
  ...
  { name:'a ferry terminal',                  found:false, solo:false, setting:'transport', noPaed:true },
  { name:'a public park',                     found:true , solo:true , setting:'outdoor', ageSkew:'young' },
  { name:'a town square',                     found:true , solo:true , setting:'outdoor'         },
  { name:'a country road layby',              found:true , solo:true , setting:'outdoor', noPaed:true },
  { name:'a beach car park',                  found:true , solo:true , setting:'outdoor'         },
  { name:'a turf bog',                        found:true , solo:true , setting:'outdoor', noPaed:true },
  { name:'a building site',                   found:true , solo:false, setting:'workplace', ageSkew:'old', noPaed:true },
  { name:'a factory floor',                   found:true , solo:false, setting:'workplace', ageSkew:'old', noPaed:true },
  { name:'a livestock mart',                  found:true , solo:false, setting:'workplace', ageSkew:'old', noPaed:true },
  { name:'a county council depot',            found:true , solo:false, setting:'workplace', ageSkew:'old', noPaed:true },
  { name:'a gym',                             found:false, solo:false, setting:'leisure'         },
  { name:'a leisure centre',                  found:false, solo:false, setting:'leisure', ageSkew:'young' },
  ...
  { name:'a nursing home',                    found:false, solo:false, setting:'clinical', ageSkew:'old', noPaed:true },
...
const PRESENTATIONS = [
  {
    ...
    variants: [
      { cause:'bee sting', conscious:true, minAge:16,
      ...
      { cause:'peanuts', conscious:true, minAge:16,
      ...
      { cause:'shellfish', conscious:true, minAge:16,
      ...
      { cause:'penicillin', conscious:true, minAge:16,
      ...
      { cause:'wasp sting (outdoor)', conscious:true, minAge:16,
      ...
      { cause:'latex / clinical exposure', conscious:true, minAge:16,
        dispatch:'You are called to {location} for a PATIENT who has become acutely unwell.',
      ...
      // ── PAEDIATRIC VARIANTS (CPG 13.21, Keith-approved). Trigger in Events only, not S/S. ──
      { cause:'paed mild allergic reaction', conscious:true, minAge:1, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT with an itchy rash.',
        presentation:'Widespread itchy raised rash (urticaria), mild facial flushing, no swelling of the lips or tongue, no wheeze or stridor, breathing comfortably, well in themselves.',
        presentationU3:'Widespread itchy raised rash (urticaria), mild facial flushing, no swelling of the lips or tongue, no wheeze or stridor, breathing comfortably, settled and interacting normally.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Widespread itchy raised rash, mild facial flushing, no lip or tongue swelling, no wheeze or stridor, breathing comfortably, well in themselves.', medications:'Nil regular.', pmh:'Nil of note.' },
        events:'Developed an itchy rash a short time after eating; otherwise well. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.2 } } },
      { cause:'paed moderate reaction', conscious:true, minAge:1, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT with swelling and a rash.',
        presentation:'Urticaria with swelling of the lips and around the eyes, mild wheeze, mild breathlessness, no stridor, no shock. Anxious.',
        presentationU3:'Urticaria with swelling of the lips and around the eyes, mild wheeze, mild breathlessness, no stridor, no shock. Unsettled.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Urticaria with swelling of the lips and around the eyes, mild wheeze, mild breathlessness, no stridor, no shock, anxious.', medications:'Nil regular.', pmh:'Known allergy.' },
        events:'Swelling and wheeze came on within minutes of a known trigger. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.45 }, rr:{ dir:'up', intensity:0.4 }, spo2:[92,96] } },
      { cause:'paed severe anaphylaxis', conscious:true, minAge:1, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT who is struggling to breathe with swelling.',
        presentation:'Swollen lips and tongue, stridor and wheeze, marked work of breathing, pale and clammy, tachycardic, widespread urticaria. Distressed and frightened.',
        presentationU3:'Swollen lips and tongue, stridor and wheeze, marked work of breathing, pale and clammy, widespread urticaria, very distressed.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Swollen lips and tongue, stridor and wheeze, marked work of breathing, pale and clammy, tachycardic, widespread urticaria, distressed.', medications:'May carry an adrenaline auto-injector.', pmh:'Known severe allergy.' },
        events:'Rapid swelling, difficulty breathing and collapse within minutes of exposure. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.6 }, rr:{ dir:'up', intensity:0.55 }, spo2:[88,93] } },
      { cause:'paed anaphylaxis with shock', conscious:true, minAge:1, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT who has collapsed after a reaction.',
        presentation:'Profound swelling, stridor, silent or wheezy chest, drowsy and floppy, very pale, poorly perfused with prolonged capillary refill, weak pulse. Hypotensive.',
        presentationU3:'Profound swelling, stridor, silent or wheezy chest, drowsy and floppy, very pale, poorly perfused with prolonged capillary refill, weak pulse.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Profound swelling, stridor, silent or wheezy chest, drowsy and floppy, very pale, poorly perfused with prolonged capillary refill, weak pulse, hypotensive.', medications:'Adrenaline auto-injector.', pmh:'Known severe allergy, previous anaphylaxis.' },
        events:'Sudden severe reaction with collapse shortly after exposure. Parent present and frightened.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.55 }, rr:{ dir:'up', intensity:0.4 }, bpSys:[70,88], spo2:[84,91] } },
    ],
    ...
    reveal: {
      ...
      drugs: [
        { name:'Adrenaline (1:1000) IM',
          ...
          paed:{ paramedic:{ route:'IM', bands:[['<6 months','10mcg/kg'],['6 months\u2013<6 yrs','150mcg'],['6\u2013<12 yrs','300mcg'],['\u226512 yrs','500mcg']], note:'Repeat at 5-minute intervals PRN. First-line, give without delay.' } } },
        { name:'Salbutamol NEB (if bronchospasm)',
          adult:{ paramedic:'5mg NEB.' },
          paed:{ paramedic:{ route:'NEB', bands:[['<5 yrs','2.5mg'],['\u22655 yrs','5mg']] } } },
        { name:'Chlorphenamine',
          adult:{ paramedic:'4mg PO, or 10mg IM (IM is Paramedic scope).', ap:'10mg IV.' },
          paed:{ paramedic:{ groups:[ { route:'PO', bands:[['6\u201311 yrs','2mg'],['\u226512 yrs','4mg']] }, { route:'IM', bands:[['1\u20136 months','0.25mg/kg'],['>6 months\u2013<6 yrs','2.5mg'],['6\u2013<12 yrs','5mg'],['\u226512 yrs','10mg']] } ] }, ap:'IV: same doses as IM, by the IV route.' } },
        { name:'Hydrocortisone',
          adult:{ paramedic:'200mg IM.', ap:'200mg IV (in 100mL NaCl).' },
          paed:{ paramedic:{ route:'IM', bands:[['<6 months','25mg'],['\u22656 months\u2013<6 yrs','50mg'],['\u22656\u2013<12 yrs','100mg'],['\u226512 yrs','200mg']] }, ap:'IV (infusion in 100mL NaCl): same doses as IM, by the IV route.' } },
        { name:'NaCl 0.9% IV/IO',
...

  {
    ...
    variants: [
      ...
      { cause:'missed meal, conscious', conscious:true, minAge:16,
      ...
      { cause:'exercise-related, conscious', conscious:true, minAge:16,
      ...
      { cause:'collapse, unresponsive', conscious:false, witness:'unwitnessed', minAge:16,
      ...
      { cause:'unresponsive', conscious:false, witness:'unwitnessed', minAge:16,
      ...
      { cause:'found drowsy at home, unresponsive', conscious:false, witness:'witnessed', onsetWhen:'earlier this evening', minAge:16,
      ...
      // ── PAEDIATRIC VARIANTS (CPG 13.11, Keith-approved) ──────────────────────────
      // Generate only as children (maxAge pins). Engine adds age-banded paed vitals,
      // paed dosing (age<=15), and swaps to presentationU3 wording when conscious & <3.
      // Guardian-present framing comes from the engine paed default.
      { cause:'paed T1DM, conscious', conscious:true, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT who has gone pale and is not themselves.',
        presentation:'Pale, sweaty and clammy, trembling. Alert but quiet and a bit muddled, answering slowly. Able to talk, hold a cup and swallow; airway their own.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Pale, sweaty and clammy, trembling, alert but quiet and muddled, answering slowly. Able to talk, hold a cup and swallow; airway own.', medications:'Insulin.', pmh:'Type 1 diabetes.' },
        events:'Took insulin as usual but ate little; became pale, shaky and not themselves over the last 20 to 30 minutes. Parent present.' },
      { cause:'paed T1DM after activity, conscious', conscious:true, minAge:5, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT who has gone pale and shaky.',
        presentation:'Sweaty, pale and trembling, clingy and unsettled and not their usual self per the parent, but fully awake, rousable and able to swallow. Airway their own.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Sweaty, pale and trembling, clingy and unsettled, not their usual self, fully awake and rousable, able to swallow. Airway own.', medications:'Insulin.', pmh:'Type 1 diabetes, usually well controlled.' },
        events:'Took the usual insulin then was far more active than normal without extra food; became shaky and pale over the last 20 minutes. Parent present.' },
      { cause:'paed toddler, pre-verbal, conscious', conscious:true, minAge:1, maxAge:2,
        dispatch:'You are called to {location} for a PATIENT who is floppy and not feeding.',
        presentation:'Drowsy and floppy, pale and clammy with profuse sweating, whimpering and not interacting as the parents say they normally would, but rousable, moving all limbs, able to swallow. Airway their own.',
        presentationU3:'Drowsy and floppy, pale and clammy with profuse sweating, whimpering and not interacting as the parents say they normally would, but rousable, moving all limbs, able to swallow. Airway their own.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Drowsy and floppy, pale and clammy with profuse sweating, whimpering and not interacting normally, but rousable, moving all limbs, able to swallow. Airway own.', medications:'Insulin (per parent).', pmh:'Type 1 diabetes (per parent).' },
        events:'Off form and feeding poorly today; became increasingly floppy and sweaty over the last while. Parent present and giving history.' },
      { cause:'paed reduced consciousness, unable to swallow', conscious:false, minAge:2, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT who cannot be roused.',
        presentation:'Deeply drowsy, responds only to a painful stimulus with a groan, profusely sweaty with cold clammy skin, breathing on their own. NOT able to swallow or protect their own airway.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Deeply drowsy, responds to pain with a groan, profusely sweaty, cold clammy skin, breathing spontaneously. Not protecting airway, cannot swallow.', medications:'Insulin (per parent).', pmh:'Diabetes (per parent).' },
        events:'Became harder and harder to rouse over the last while.' },
    ],
    ...
    reveal: {
      ...
      drugs: [
        { name:'Glucose Gel (Consider)',
          ...
          paed:{ paramedic:{ route:'Buccal', bands:[['\u22648 yrs','5\u201310g'],['>8 yrs','10\u201320g']], note:'Plus a sweetened drink. For the conscious, swallowing patient.' } } },
        { name:'Glucagon',
          adult:{ paramedic:'1mg IM. For the patient who cannot swallow / is unresponsive.' },
          paed:{ paramedic:{ route:'IM', bands:[['\u22651 month\u2013<6 yrs','500mcg'],['\u22656 yrs','1mg']], note:'For the patient who cannot swallow / is unresponsive.' } } },
...

  {
    ...
    demographics: { minAge: 1, maxAge: 90, sex: 'any' },
    variants: [
      { cause:'scald burn', conscious:true, minAge:16,
      ...
      { cause:'flame burn, larger area', conscious:true, minAge:16,
      ...
      { cause:'burn with inhalation injury', conscious:true, minAge:16,
      ...
      { cause:'chemical burn', conscious:true, minAge:16,
      ...
      { cause:'electrical burn', conscious:true, minAge:16,
      ...
      { cause:'large burn with inhalation, severe', conscious:true, minAge:16,
      ...
      // ── PAEDIATRIC VARIANTS (CPG 13.15, Keith-approved). Mechanism in Events, not S/S. ──
      { cause:'paed scald, small superficial', conscious:true, minAge:1, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT who has been scalded.',
        presentation:'Red, painful, blistering area to the forearm or trunk, crying and distressed, otherwise well, breathing normally.',
        presentationU3:'Red, painful, blistering area to the forearm or trunk, crying and inconsolable, otherwise well, breathing normally.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Red, painful, blistering area to the forearm or trunk, distressed, otherwise well, breathing normally.', medications:'Nil.', pmh:'Nil of note.' },
        opqrst:{ onset:'Just now.', provocation:'The burn is very sore.', quality:'Hot, stinging, painful burn.', radiates:'No.', severity:'6', time:'Moments ago.' },
        events:'Pulled a hot drink or pot over themselves a short time ago. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.35 } } },
      { cause:'paed scald, larger area', conscious:true, minAge:1, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT with a large scald.',
        presentation:'Larger red, blistered and painful burn across the trunk and arm, very distressed, but airway clear and breathing normal.',
        presentationU3:'Larger red, blistered and painful burn across the trunk and arm, very distressed and inconsolable, but airway clear and breathing normal.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Larger red, blistered and painful burn across the trunk and arm, very distressed, airway clear, breathing normal.', medications:'Nil.', pmh:'Nil of note.' },
        opqrst:{ onset:'Just now.', provocation:'The burn is very sore.', quality:'Hot, stinging, painful burn.', radiates:'Across the trunk and arm.', severity:'7', time:'Moments ago.' },
        events:'Hot liquid over a larger area; cooled by parents before arrival. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.45 } } },
      { cause:'paed flame burn with inhalation concern', conscious:true, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT burned in a fire.',
        presentation:'Burns to the face and chest, soot around the nose and mouth, hoarse voice and cough, singed nasal hair, breathing a little fast. Distressed.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Burns to the face and chest, soot around the nose and mouth, hoarse voice and cough, singed nasal hair, breathing a little fast, distressed.', medications:'Nil.', pmh:'Nil of note.' },
        opqrst:{ onset:'During the fire.', provocation:'Sore burns; cough and hoarseness.', quality:'Painful burns with airway irritation.', radiates:'No.', severity:'6', time:'Recently, during the fire.' },
        events:'House fire or clothing caught with smoke exposure. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.5 }, rr:{ dir:'up', intensity:0.45 }, spo2:[90,95] } },
      { cause:'paed large burn, severe', conscious:true, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a critically injured PATIENT.',
        presentation:'Extensive burns over a large body area, pale and shocked, poorly perfused, drowsy, breathing fast. Soot and hoarseness suggest airway involvement.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Extensive burns over a large body area, pale and shocked, poorly perfused, drowsy, breathing fast, soot and hoarseness.', medications:'Nil.', pmh:'Nil of note.' },
        opqrst:{ onset:'During the fire.', provocation:'Severe burns.', quality:'Severe burns with shock.', radiates:'Widespread.', severity:'8', time:'Recently, during the fire.' },
        events:'Significant fire exposure. Parent present and distressed.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.6 }, rr:{ dir:'up', intensity:0.55 }, bpSys:[78,94], spo2:[86,92] } },
    ],
    ...
    reveal: {
      ...
      drugs: [
        { name:'Oxygen therapy (humidified)',
          adult:{ paramedic:'Consider, especially with inhalation or facial injury.' },
          paed:{ paramedic:'As required, humidified, especially with inhalation or facial injury.' } },
        { name:'NaCl 0.9% (fluids)',
          adult:{ ap:'Consider 500mL IV/IO; 1000mL IV/IO if TBSA > 25% or > 1 hour from injury to ED.' },
          paed:{ ap:{ lead:'If >10% TBSA and/or >1 hour from injury to ED:', route:'IV/IO', bands:[['5\u201310 yrs','250mL'],['>10 yrs','500mL']] } } },
      ],
    },
  },
  ...
  },
  {
    ...
    variants: [
      ...
      { cause:'known epilepsy, postictal', conscious:true, witness:'witnessed', minAge:16, onsetWhen:'about 15 minutes ago',
      ...
      { cause:'first-ever seizure, postictal', conscious:true, witness:'witnessed', minAge:16, onsetWhen:'about 20 minutes ago',
      ...
      { cause:'alcohol-withdrawal seizure, postictal', conscious:true, witness:'unwitnessed', minAge:16,
      ...
      { cause:'post-head-injury seizure, postictal', conscious:true, witness:'witnessed', minAge:16, onsetWhen:'about 15 minutes ago',
      ...
      { cause:'prolonged active seizure', conscious:false, witness:'witnessed', minAge:16,
      ...
      { cause:'recurrent seizures without recovery', conscious:false, witness:'witnessed', minAge:16,
      ...
      // ── PAEDIATRIC VARIANTS (CPG 13.14, Keith-approved). Cause/fever context in Events. ──
      { cause:'paed febrile convulsion, postictal', conscious:true, minAge:1, maxAge:5, witness:'witnessed', onsetWhen:'a short time ago',
        dispatch:'You are called to {location} for a PATIENT who has had a fit.',
        presentation:'Drowsy and floppy after the event, hot and flushed, slowly recovering awareness, breathing on their own. Now settled, not seizing.',
        presentationU3:'Drowsy and floppy after the event, hot and flushed, slowly recovering awareness, breathing on their own. Now settled, not seizing.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Drowsy and floppy after the event, hot and flushed, slowly recovering awareness, breathing on their own, now settled.', medications:'Nil regular.', pmh:'Otherwise well.' },
        events:'Had a brief generalised seizure during a fever; now postictal. Parent present and frightened.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.4 }, temp:[38.5,39.8] } },
      { cause:'paed known epilepsy, postictal', conscious:true, minAge:3, maxAge:15, witness:'witnessed', onsetWhen:'about 15 minutes ago',
        dispatch:'You are called to {location} for a PATIENT recovering after a seizure.',
        presentation:'Postictal and drowsy, confused and slowly orientating, no longer convulsing, breathing on their own.',
        presentationU3:'Postictal and drowsy, floppy and slowly settling, no longer convulsing, breathing on their own.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Postictal and drowsy, confused and slowly orientating, no longer convulsing, breathing on their own.', medications:'Anti-epileptic medicine (parent names it).', pmh:'Epilepsy.' },
        events:'Known epilepsy, had a witnessed seizure, now recovering. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.35 } } },
      { cause:'paed prolonged active seizure', conscious:false, minAge:1, maxAge:15, witness:'witnessed',
        dispatch:'You are called to {location} for a PATIENT who is fitting.',
        presentation:'Actively convulsing with generalised tonic-clonic movements, not responding, frothing, beginning to cyanose, has been seizing for several minutes.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Actively convulsing, generalised tonic-clonic movements, not responding, frothing, beginning to cyanose, seizing for several minutes.', medications:'Nil known (per parent).', pmh:'Nil known (per parent).' },
        events:'Seizure ongoing and not self-terminating. Parent present and distressed.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.55 }, spo2:[88,94] } },
      { cause:'paed recurrent seizures without recovery', conscious:false, minAge:1, maxAge:15, witness:'witnessed',
        dispatch:'You are called to {location} for a PATIENT having repeated fits.',
        presentation:'Recurrent convulsions without regaining consciousness between them, poor respiratory effort, cyanosed. A benzodiazepine has already been given.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Recurrent convulsions without regaining consciousness between them, poor respiratory effort, cyanosed.', medications:'Buccal midazolam given before arrival (per parent).', pmh:'Epilepsy.' },
        events:'Repeated seizures without recovery; a benzodiazepine was given before arrival. Parent present and distressed.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.6 }, spo2:[85,92] } },
    ],
    painBased: false,
    ...
    reveal: {
      ...
      drugs: [
        ...
        { name:'Oxygen Therapy',
          ...
          paed:{ paramedic:'Support the airway and oxygenation. Check blood glucose. Febrile child: go to the Pyrexia pathway.' } },
      ],
    },
  },

  {
    ...
    category: 'Trauma',
    demographics: { minAge: 3, maxAge: 90, sex: 'any' },
    variants: [
      // V1: catastrophic limb bleed → tourniquet. Anticoagulant cue (Eliquis) = bleeds worse.
      { cause:'catastrophic limb haemorrhage', conscious:true, minAge:16,
      ...
      { cause:'junctional haemorrhage', conscious:true, minAge:16,
      ...
      { cause:'haemorrhage controlled with pressure', conscious:true, minAge:16,
      ...
      { cause:'haemorrhage requiring escalation', conscious:true, minAge:16,
      ...
      { cause:'traumatic amputation', conscious:true, minAge:16,
      ...
      { cause:'major haemorrhage with significant blood loss', conscious:false, minAge:16,
      ...
      // ── PAEDIATRIC VARIANTS (CPG 13.16, Keith-approved). Mechanism in Events. ──
      { cause:'paed controlled bleed', conscious:true, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT with a bleeding wound.',
        presentation:'A bleeding wound to the forearm or leg, bleeding slowing with direct pressure, distressed but otherwise well perfused.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'A bleeding wound to the forearm or leg, bleeding slowing with direct pressure, distressed but otherwise well perfused.', medications:'Nil.', pmh:'Nil of note.' },
        opqrst:{ onset:'Just now.', provocation:'The wound is sore.', quality:'Painful cut.', radiates:'No.', severity:'5', time:'Moments ago.' },
        events:'Fell onto something sharp or glass; bleeding controlled with pressure. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.3 } } },
      { cause:'paed catastrophic limb haemorrhage', conscious:true, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT bleeding heavily from a limb.',
        presentation:'Heavy, pulsatile bleeding from a limb wound not controlled by pressure, blood loss on the floor, pale and frightened.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Heavy, pulsatile bleeding from a limb wound not controlled by pressure, blood loss on the floor, pale and frightened.', medications:'Nil.', pmh:'Nil of note.' },
        opqrst:{ onset:'Just now.', provocation:'Severe.', quality:'Severe bleeding wound.', radiates:'No.', severity:'8', time:'Moments ago.' },
        events:'Major laceration to a limb; bleeding heavily. Parent present and distressed.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.5 }, bpSys:[80,98] } },
      { cause:'paed haemorrhage requiring escalation', conscious:true, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT with a wound that keeps bleeding.',
        presentation:'A deep wound continuing to bleed despite dressing and pressure, becoming pale and anxious, mild tachycardia.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'A deep wound continuing to bleed despite dressing and pressure, becoming pale and anxious, mild tachycardia.', medications:'Nil.', pmh:'Nil of note.' },
        opqrst:{ onset:'A short time ago.', provocation:'The wound keeps bleeding.', quality:'Painful, persistently bleeding wound.', radiates:'No.', severity:'6', time:'A short time ago, still bleeding.' },
        events:'Wound continues to bleed through dressings. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.45 } } },
      { cause:'paed major haemorrhage with shock', conscious:false, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT who has collapsed and is bleeding heavily.',
        presentation:'Heavy blood loss, pale, cold and poorly perfused, drowsy and unresponsive to voice, weak fast pulse.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Heavy blood loss, pale, cold and poorly perfused, drowsy and unresponsive to voice, weak fast pulse.', medications:'Nil.', pmh:'Nil of note.' },
        events:'Significant traumatic bleed; collapsed. Parent present and distressed.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.6 }, bpSys:[60,82], bpDia:[34,52], spo2:[86,93] } },
    ],
...

  {
    ...
    variants: [
      ...
      { cause:'cardiac arrest, basic life support', conscious:false, witness:'witnessed', minAge:16, arrestRhythm:'Not yet determined (pads being attached)',
      ...
      { cause:'cardiac arrest, VF or pulseless VT', conscious:false, witness:'witnessed', minAge:16, arrestRhythm:'VF / pulseless VT (shockable)',
      ...
      { cause:'cardiac arrest, pulseless electrical activity', conscious:false, witness:'unwitnessed', minAge:16, arrestRhythm:'PEA (organised rhythm, no pulse)',
      ...
      // ── PAEDIATRIC ARREST VARIANTS (CPG 13.22/13.23/13.24, Keith-approved). Guardian present. ──
      { cause:'paed arrest, BLS entry', conscious:false, witness:'witnessed', minAge:1, maxAge:15, arrestRhythm:'Not yet determined (pads being attached)',
        dispatch:'You are called to {location} for a PATIENT who is unresponsive and not breathing.',
        presentation:'Unresponsive, not breathing normally or only agonal gasps, no pulse. CPR in progress.',
        allergies:'Unknown.',
        sample:{ symptoms:'Unresponsive, not breathing normally, no pulse, CPR in progress.', medications:'Nil known (per parent).', pmh:'Nil known (per parent).', lastIntake:'Per parent.' },
        events:'Collapsed and became unresponsive; a parent is present and bystander CPR was started. Parent present and distressed.' },
      { cause:'paed arrest, VF or pulseless VT', conscious:false, witness:'witnessed', minAge:1, maxAge:15, arrestRhythm:'VF / pulseless VT (shockable)',
        dispatch:'You are called to {location} for a PATIENT who has collapsed and is unresponsive.',
        presentation:'Unresponsive, pulseless, apnoeic. The monitor shows a shockable rhythm.',
        allergies:'Unknown.',
        sample:{ symptoms:'Unresponsive, pulseless, apnoeic; shockable rhythm on the monitor.', medications:'Nil known (per parent).', pmh:'Nil known (per parent).', lastIntake:'Per parent.' },
        events:'Sudden collapse with a shockable rhythm on the monitor; a parent is present. Parent present and distressed.' },
      { cause:'paed arrest, asystole or PEA', conscious:false, witness:'witnessed', minAge:1, maxAge:15, arrestRhythm:'Asystole / PEA (non-shockable)',
        dispatch:'You are called to {location} for a PATIENT who is unresponsive and not breathing.',
        presentation:'Unresponsive, pulseless, apnoeic. The monitor shows a non-shockable rhythm. (In children, arrest is most often secondary to a respiratory or hypoxic cause.)',
        allergies:'Unknown.',
        sample:{ symptoms:'Unresponsive, pulseless, apnoeic; non-shockable rhythm on the monitor.', medications:'Nil known (per parent).', pmh:'Nil known (per parent).', lastIntake:'Per parent.' },
        events:'Became unresponsive, often after a period of breathing difficulty; CPR started with a parent present. Parent present and distressed.' },
    ],
    painBased: false,
    ...
    reveal: {
      ...
      drugs: [
        { name:'High-quality CPR & Defibrillation',
          ...
          paed:{ paramedic:'5 rescue ventilations first. CPR 15:2 (two-rescuer paed) or 30:2 (one rescuer; \u226512 yrs two-rescuer 30:2). Rate 100 to 120, depth one third of chest. <8 yrs use paediatric defibrillation system. Defibrillate shockable rhythms at 4 J/kg.' } },
        { name:'Oxygen / Airway',
          adult:{ paramedic:'Airway management and oxygen therapy throughout.' },
          paed:{ paramedic:'Airway and ventilation are central in children (arrest is usually secondary to hypoxia). 100% oxygen throughout.' } },
        { name:'Arrest drugs',
          adult:{ ap:'Advanced Paramedics administer adrenaline and amiodarone (refractory shockable rhythms).' },
          paed:{ ap:'Adrenaline (1:10,000) 10 mcg/kg IV/IO, repeat every 3 to 5 minutes (every 2nd cycle) PRN. Amiodarone 5 mg/kg IV/IO for refractory VF/pVT after the 3rd shock. PEA: consider fluid challenge NaCl 0.9% 20 mL/kg IV/IO. Consider the 4 Hs and 4 Ts.' } },
        { name:'Post-ROSC care',
          paed:{ paramedic:'After return of spontaneous circulation: maintain oxygenation and ventilation (PPV max 12 to 20 per minute), target temperature, 12-lead ECG, monitor BP and GCS, check blood glucose. If persistent poor perfusion or systolic BP below the 5th centile (70 mmHg + (2 \u00d7 age)): NaCl 0.9% 20 mL/kg IV/IO (AP).' } },
      ],
    },
  },

  {
    ...
    reveal: {
      ...
      diagnosisBlocks: [
        { type:'lead', env:'hypo', body:'Environmental emergency: hypothermia (low core temperature). Check and record the temperature and blood glucose.' },
        { type:'lead', env:'heat', body:'Environmental emergency: heat-related emergency (high core temperature). Check and record the temperature and blood glucose.' },
        { type:'lead', env:'drown', body:'Environmental emergency: submersion / drowning incident. Check and record the temperature and blood glucose.' },
        { type:'lead', env:'dci', body:'Environmental emergency: decompression illness after recent SCUBA diving. Check and record the temperature and blood glucose.' },
        { type:'note', env:'hypo', body:'Hypothermia severity by core temperature: Mild 34 to 35.9, Moderate 30 to 33.9, Severe below 30.' },
        { type:'note', env:'heat', body:'Heat: heat stress, heat exhaustion, or heat stroke above 40.' },
        { type:'note', env:'dci', body:'Decompression illness: suspect in any diver with new joint or limb pain, neurological signs, a rash or breathlessness within 48 hours of a SCUBA dive. The dive buddy may also be affected, assess them too.' },
      ],
      pathwayBlocks: [
        { type:'branch', env:'hypo', label:'Hypothermia', body:'Handle gently, do not let them walk. Remove wet clothing by cutting, insulate. Pulse check 30 to 45 seconds. Passive re-warming; hot sweet drinks if mild. Transport head-down.' },
        { type:'branch', env:'heat', label:'Heat emergency', body:'Remove from the heat. If alert, cool fluids to drink; if not, maintain the airway. Cool the patient but do not over-cool (clothing off, fanning, tepid sponging, ice packs).' },
        { type:'branch', env:'drown', label:'Drowning / submersion', body:'Remove from the liquid (C-spine caution). Rescue breaths if needed, oxygen, auscultate. Transport to ED for secondary drowning even if they look well.' },
        { type:'branch', env:'dci', label:'Decompression illness', body:'Treat SUPINE. 100% oxygen. Request ALS. Entonox is ABSOLUTELY contraindicated (it expands gas bubbles), use the Pain CPG. Alert ED, notify query DCI. Transport below 1000 ft above the incident site; bring the dive computer and equipment.' },
        { type:'step', body:'Check blood glucose in all. Consider or request ALS as indicated.' },
      ],
      interventionsBlocks: [
        { type:'step', env:'hypo', body:'Hypothermia: gentle handling, insulation, passive re-warming, ECG/SpO2, head-down transport.' },
        { type:'step', env:'heat', body:'Heat: remove from heat, cool without over-cooling, cool fluids if alert.' },
        { type:'step', env:'drown', body:'Drowning: airway and oxygen, rescue breaths if needed, manage bronchospasm, always transport to ED for possible secondary drowning.' },
        { type:'note', env:'dci', body:'Decompression illness: 100% oxygen, supine, NO Entonox (expands gas bubbles), transport below 1000 ft. NaCl 0.9% 500 mL IV/IO is Advanced Paramedic scope.' },
        { type:'note', body:'Check blood glucose in all.' },
      ],
      drugs: [
        ...
        { name:'Salbutamol (drowning, if bronchospasm)', env:'drown',
          adult:{ paramedic:'5mg nebulised for bronchospasm.' } },
        { name:'Re-warming', env:'hypo',
          adult:{ paramedic:'Passive re-warming, insulation, head-down.' }, ap:{ ap:'Warmed fluids and advanced airway. Advanced Paramedic scope.' } },
        { name:'Cooling', env:'heat',
          adult:{ paramedic:'Cool without over-cooling.' } },
        { name:'Fluids (heat)', env:'heat',
          adult:{ ap:'NaCl. Advanced Paramedic scope.' } },
        { name:'Oxygen 100% (decompression illness)', env:'dci',
          adult:{ paramedic:'100% oxygen. Entonox is ABSOLUTELY contraindicated, it expands the gas bubbles.' } },
        { name:'Sodium Chloride 0.9% (decompression illness)', env:'dci',
...

  {
    ...
    demographics: { minAge: 3, maxAge: 75, sex: 'any' },
    variants: [
      // V1: Mild — speaking full sentences, settling. Near-normal vitals.
      { cause:'mild asthma', conscious:true, minAge:16,
      ...
      { cause:'moderate asthma', conscious:true, minAge:16,
      ...
      { cause:'severe asthma', conscious:true, minAge:16,
        dispatch:'You are called to {location} for a PATIENT in severe respiratory distress.',
      ...
      { cause:'life-threatening asthma', conscious:true, minAge:16,
      ...
      // ── PAEDIATRIC VARIANTS (CPG 13.8, Keith-approved). Severity ladder, trigger-free. ──
      { cause:'paed mild asthma', conscious:true, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT who is wheezy and short of breath.',
        presentation:'Mild wheeze, speaking in full sentences or playing fairly normally, mildly breathless but settling, not distressed.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Mild wheeze, speaking in full sentences or interacting fairly normally, mildly breathless but settling, not distressed.', medications:'Ventolin.', pmh:'Asthma.' },
        opqrst:{ onset:'Came on a little while ago.', provocation:'Eases with the inhaler.', quality:'Mild tightness and wheeze, not distressing.', radiates:'No.', severity:'2', time:'A short while, settling.' },
        events:'Became wheezy and used their own inhaler with some effect before calling. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.2 }, rr:{ dir:'up', intensity:0.25 }, spo2:[94,98] } },
      { cause:'paed moderate asthma', conscious:true, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT struggling with their breathing.',
        presentation:'Audible wheeze, speaking in short phrases or quieter and less playful, increased work of breathing with some accessory muscle use and mild recession.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Audible wheeze, short phrases or quieter and less playful, increased work of breathing, accessory muscle use, mild recession.', medications:'Ventolin.', pmh:'Asthma.' },
        opqrst:{ onset:'Worsening over the last while.', provocation:'The inhaler is not helping much now.', quality:'Tight, wheezy, hard work to breathe.', radiates:'No.', severity:'5', time:'Worsening over a period.' },
        events:'Breathlessness worsening despite repeated use of their own inhaler. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.45 }, rr:{ dir:'up', intensity:0.5 }, spo2:[91,95] } },
      { cause:'paed severe asthma', conscious:true, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT in severe respiratory distress.',
        presentation:'Marked wheeze, only a few words at a time, working hard to breathe with marked recession and tracheal tug, anxious and tiring, sitting forward.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Marked wheeze, a few words at a time, working hard with marked recession and tracheal tug, anxious and tiring, sitting forward.', medications:'Ventolin.', pmh:'Asthma, previous admissions.' },
        opqrst:{ onset:'Worsening despite treatment.', provocation:'Nothing is easing it now.', quality:'Severe tightness, exhausting to breathe.', radiates:'No.', severity:'7', time:'Steadily worsening and not responding.' },
        events:'Breathing deteriorated despite repeated inhaler use, now severely distressed. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.6 }, rr:{ dir:'up', intensity:0.6 }, spo2:[88,93] } },
      { cause:'paed life-threatening asthma', conscious:true, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT who is barely breathing.',
        presentation:'Exhausted and barely able to speak, a silent chest on auscultation, cyanosed and drowsy, with poor respiratory effort.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Exhausted, barely able to speak, silent chest on auscultation, cyanosed, drowsy, poor respiratory effort.', medications:'Ventolin.', pmh:'Asthma, previous ICU or HDU admission.' },
        opqrst:{ onset:'Has deteriorated badly.', provocation:'Nothing is helping.', quality:'Too breathless and exhausted to describe it.', radiates:'No.', severity:'9', time:'Rapidly worsening to exhaustion.' },
        events:'Severe attack progressed to exhaustion despite treatment. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.5 }, rr:{ dir:'up', intensity:0.3 }, spo2:[78,88] } },
    ],
    painBased: false,
    ...
    reveal: {
      ...
      drugs: [
        { name:'Salbutamol (mainstay, Paramedic scope)',
          ...
          paed:{ paramedic:{ route:'NEB', bands:[['<5 yrs','2.5mg'],['\u22655 yrs','5mg']], note:'Or 100mcg metered aerosol, repeatable. Life-threatening: age-specific NEB every 5 minutes PRN.' } } },
        { name:'Ipratropium + Salbutamol (Paramedic)',
          ...
          paed:{ paramedic:{ route:'NEB', bands:[['<12 yrs','250mcg'],['\u226512 yrs','500mcg']], note:'Mixed with age-specific Salbutamol. Moderate and worse.' } } },
        { name:'Hydrocortisone (severe)',
          adult:{ ap:'100mg slow IV (infusion in 100mL NaCl 0.9%).' },
          paed:{ ap:{ route:'IV (in 100mL NaCl 0.9%)', bands:[['<1 yr','25mg'],['1\u20135 yrs','50mg'],['>5 yrs','100mg']] } } },
        { name:'Magnesium Sulphate (life-threatening)',
          adult:{ ap:'2g IV (infusion in 100mL NaCl 0.9%).' },
          paed:{ ap:'Advanced Paramedic, per paediatric guidance.' } },
      ],
    },
  },
...

  {
    ...
    category: 'Endocrine',
    demographics: { minAge: 3, maxAge: 80, sex: 'any' },
    variants: [
      // V1: Known Addison's, intercurrent illness, early (not yet in crisis).
      { cause:'known Addisons with intercurrent illness', conscious:true, minAge:16,
      ...
      { cause:'Addisonian crisis with hypotension', conscious:true, minAge:16,
      ...
      { cause:'Addisonian crisis with hypoglycaemia', conscious:true, minAge:16,
      ...
      { cause:'severe Addisonian crisis with collapse', conscious:false, minAge:16,
        dispatch:'You are called to {location} for a PATIENT who has collapsed.',
      ...
      // ── PAEDIATRIC VARIANTS (CPG 13.10, Keith-approved) ──────────────────────────
      { cause:'paed known Addisons, crisis, conscious', conscious:true, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT who is vomiting and very weak.',
        presentation:'Pale and unwell, lethargic and weak, vomiting, complaining of abdominal and back pain, dizzy and faint when sat up. Looks dehydrated.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Pale and unwell, lethargic and weak, vomiting, abdominal and back pain, dizzy and faint when sat up, looks dehydrated.', medications:'Hydrocortisone.', pmh:'Addisons disease / adrenal insufficiency.' },
        opqrst:{ onset:'Building over a day or two with a recent illness.', provocation:'Worse when sat up; vomiting, cannot keep things down.', quality:'Weak, drained, sore in the abdomen and back.', radiates:'Across the abdomen and lower back.', severity:'5', time:'Gradually worse over a day or two.' },
        events:'Known Addisons, recently unwell with a viral illness and not keeping steroids or food down, now increasingly weak and vomiting. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.5 }, bpSys:[84,100], bpDia:[50,64] } },
      { cause:'paed known Addisons, reduced consciousness', conscious:false, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT who cannot be roused.',
        presentation:'Drowsy and difficult to rouse, pale and clammy, poorly perfused with prolonged capillary refill, breathing on their own. Vomiting noted.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Drowsy and difficult to rouse, pale and clammy, poorly perfused with prolonged capillary refill, breathing spontaneously, vomiting noted.', medications:'Hydrocortisone (per parent).', pmh:'Addisons disease (per parent).' },
        opqrst:{ onset:'Became drowsy after a couple of days of vomiting and illness.', provocation:'Unknown.', quality:'Unknown.', radiates:'Unknown.', severity:'Unknown.', time:'Increasingly drowsy over a couple of days.' },
        events:'Known Addisons, became increasingly drowsy after a couple of days of vomiting and illness. Parent present and giving history.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.55 }, bpSys:[78,94], bpDia:[46,60] } },
    ],
    painBased: false,
    ...
    reveal: {
      ...
      drugs: [
        { name:'Hydrocortisone',
          adult:{ paramedic:'100 mg IM. Within Paramedic scope, so the crisis can be treated without IV access.', ap:'100 mg IV in 100 mL NaCl 0.9%, infused over 20 to 30 minutes.' },
          paed:{ paramedic:{ lead:'IM (consider if IV not available):', route:'IM', bands:[['6 mth\u2013\u22645 yrs','50 mg'],['>5 yrs','100 mg']] }, ap:{ route:'IV (in 100 mL NaCl 0.9%)', bands:[['6 mth\u2013\u22645 yrs','50 mg'],['>5 yrs','100 mg']] } } },
        { name:'Sodium Chloride 0.9% (fluids)',
          adult:{ ap:'1L IV infusion for hypotension and dehydration. Advanced Paramedic scope only (IV access required).' },
          paed:{ ap:'20 mL/kg IV for hypotension and dehydration. Advanced Paramedic scope only (IV access required).' } },
        { name:'Oxygen',
          adult:{ paramedic:'As required to maintain oxygenation.' },
          paed:{ paramedic:'As required to maintain oxygenation.' } },
      ],
    },
  },
...

  {
    ...
    demographics: { minAge: 3, maxAge: 60, sex: 'any' },
    painBased: true,
    variants: [
      // V1: Vaso-occlusive pain crisis — the classic.
      { cause:'vaso-occlusive pain crisis', conscious:true, minAge:16,
      ...
      { cause:'sickle crisis with fever', conscious:true, minAge:16,
      ...
      { cause:'sickle crisis with dehydration', conscious:true, minAge:16,
      ...
      { cause:'acute chest crisis', conscious:true, minAge:16,
      ...
      // ── PAEDIATRIC VARIANTS (CPG 13.12, Keith-approved). ──
      { cause:'paed vaso-occlusive pain crisis', conscious:true, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT in severe pain.',
        presentation:'Severe pain in the limbs, back or abdomen, distressed and crying, guarding the painful areas, otherwise well perfused.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Severe pain in the limbs, back or abdomen, distressed and crying, guarding the painful areas, otherwise well perfused.', medications:'Folic acid (per care plan).', pmh:'Sickle cell disease.' },
        opqrst:{ onset:'Came on over a few hours.', provocation:'Movement makes it worse.', quality:'Deep, severe aching pain.', radiates:'Limbs, back or abdomen.', severity:'8', time:'Over a few hours, worse than usual.' },
        events:'Known sickle cell, a painful crisis came on, worse than the relief managed at home. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.4 } } },
      { cause:'paed sickle crisis with fever', conscious:true, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT in pain with a temperature.',
        presentation:'Painful crisis with fever, flushed and unwell, breathing a little fast.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Painful crisis with fever, flushed and unwell, breathing a little fast.', medications:'Folic acid (per care plan).', pmh:'Sickle cell disease.' },
        opqrst:{ onset:'Pain and fever over the day.', provocation:'Movement worsens the pain.', quality:'Severe aching pain with fever.', radiates:'Limbs and back.', severity:'7', time:'Over the day, with a temperature.' },
        events:'Painful crisis with a temperature. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.5 }, rr:{ dir:'up', intensity:0.3 }, temp:[38.5,39.8] } },
      { cause:'paed sickle crisis with dehydration', conscious:true, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT in pain who is unwell and dehydrated.',
        presentation:'Painful crisis, dry and dehydrated, not drinking, lethargic, prolonged capillary refill.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Painful crisis, dry and dehydrated, not drinking, lethargic, prolonged capillary refill.', medications:'Folic acid (per care plan).', pmh:'Sickle cell disease.' },
        opqrst:{ onset:'Pain over the day, now not drinking.', provocation:'Movement worsens the pain.', quality:'Severe aching pain.', radiates:'Limbs and back.', severity:'7', time:'Over the day, becoming dehydrated.' },
        events:'Painful crisis, unable to keep fluids down, becoming dehydrated. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.5 } } },
    ],
    ...
    reveal: {
      ...
      drugs: [
        { name:'Oxygen',
          adult:{ paramedic:'15L via non-rebreather mask (high-flow).' },
          paed:{ paramedic:'100% oxygen.' } },
        { name:'Sodium Chloride 0.9% (fluids)',
          adult:{ ap:'1L IV infusion if dehydrated and unable to take oral fluids. Advanced Paramedic scope only (IV access required).' },
          paed:{ ap:'10 mL/kg IV if dehydrated and unable to take oral fluids. Advanced Paramedic scope only (IV access required).' } },
        { name:'Analgesia',
          paed:{ paramedic:'Per the Pain Management pathway. Warm to normal temperature if cold; encourage oral fluids. Fever: go to the Pyrexia pathway.' } },
      ],
    },
  },
...

  {
    ...
    variants: [
      ...
      { cause:'mid-shaft femur fracture', conscious:true, minAge:16,
      ...
      { cause:'neck of femur fracture', conscious:true, minAge:16,
      ...
      { cause:'open fracture', conscious:true, minAge:16,
      ...
      { cause:'joint dislocation', conscious:true, minAge:16,
      ...
      { cause:'soft tissue limb injury', conscious:true, minAge:16,
        ...
        vitalsOverride:{ hr:{ dir:'up', intensity:0.2 } } },
      // ── PAEDIATRIC VARIANTS (CPG 13.18, Keith-approved). Mechanism in Events. ──
      { cause:'paed closed forearm fracture', conscious:true, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT who has hurt their arm.',
        presentation:'Painful, swollen, deformed forearm, guarding the arm, good colour and pulses in the hand, very distressed.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Painful, swollen, deformed forearm, guarding the arm, good colour and pulses in the hand, very distressed.', medications:'Nil.', pmh:'Nil of note.' },
        opqrst:{ onset:'When they fell.', provocation:'Any movement hurts.', quality:'Sharp, severe arm pain.', radiates:'No.', severity:'7', time:'Since the fall.' },
        events:'Fell onto an outstretched hand at the playground or off a trampoline. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.35 } } },
      { cause:'paed femur fracture', conscious:true, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT with a serious leg injury.',
        presentation:'Painful, shortened and externally rotated thigh, unable to weight-bear, marked distress, distal pulses present.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Painful, shortened and externally rotated thigh, unable to weight-bear, marked distress, distal pulses present.', medications:'Nil.', pmh:'Nil of note.' },
        opqrst:{ onset:'At the time of the injury.', provocation:'Any movement is agony.', quality:'Severe, deep thigh pain.', radiates:'No.', severity:'8', time:'Since the injury.' },
        events:'Significant fall or impact to the leg. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.45 } } },
      { cause:'paed open fracture', conscious:true, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT with an open leg injury.',
        presentation:'Deformed lower leg with bone visible through a wound, bleeding controlled, severe pain, distal pulses present.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Deformed lower leg with bone visible through a wound, bleeding controlled, severe pain, distal pulses present.', medications:'Nil.', pmh:'Nil of note.' },
        opqrst:{ onset:'At the time of the injury.', provocation:'Severe with any movement.', quality:'Severe pain at an open fracture.', radiates:'No.', severity:'9', time:'Since the injury.' },
        events:'Fall with an open wound over the fracture. Parent present and distressed.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.5 } } },
      { cause:'paed dislocation', conscious:true, minAge:6, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT with an injured joint.',
        presentation:'Obvious deformity at the knee or shoulder, held in a fixed position, severe pain on any movement, neurovascularly intact distally.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Obvious deformity at the knee or shoulder, held in a fixed position, severe pain on any movement, neurovascularly intact distally.', medications:'Nil.', pmh:'Nil of note.' },
        opqrst:{ onset:'During the injury.', provocation:'Any movement is severe.', quality:'Severe joint pain.', radiates:'Around the joint.', severity:'8', time:'Since the injury.' },
        events:'Twisting injury during sport. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.4 } } },
    ],
    ...
    reveal: {
      ...
      drugs: [
        { name:'Sodium Chloride 0.9% (fluids)',
          adult:{ ap:'250 mL IV for a mid-shaft femur fracture. Advanced Paramedic scope only (IV access required).' },
          paed:{ ap:'For a mid-shaft femur fracture. Advanced Paramedic scope only (IV access required).' } },
        { name:'Ceftriaxone',
          adult:{ ap:'2g IV/IO/IM for an open fracture (after removing gross contamination). Advanced Paramedic scope.' },
          paed:{ ap:{ lead:'Open fracture (after removing gross contamination):', route:'IV/IO/IM', bands:[['1 month\u201311 yrs','50mg/kg'],['>11 yrs','2g']], note:'Advanced Paramedic scope.' } } },
      ],
    },
  },

  // ════════════════════════════════════════════════════════════════════════════
  // PAEDIATRIC PRESENTATIONS (CPG chapter 13, Keith-approved)
  // ════════════════════════════════════════════════════════════════════════════

  {
    id: 'pyrexiaPaed',
    name: 'Pyrexia (Paediatric)',
    category: 'Infectious',
    demographics: { minAge: 1, maxAge: 12, sex: 'any' },
    variants: [
      { cause:'febrile child, alert, distressed', conscious:true, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT who is hot and unwell.',
        presentation:'Flushed and hot to touch, miserable and irritable, cheeks red, clingy and off form. Alert, taking sips when offered. Breathing a little fast.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Flushed and hot to touch, miserable and irritable, red cheeks, clingy and off form, alert and taking sips, breathing a little fast.', medications:'Nil regular.', pmh:'Nil of note.' },
        events:'Hot and unsettled since earlier today; parent took the temperature and it was high. Parent present.' },
      { cause:'febrile toddler, pre-verbal', conscious:true, minAge:1, maxAge:2,
        dispatch:'You are called to {location} for a PATIENT who is hot and not feeding.',
        presentation:'Hot and flushed, whimpering and inconsolable, not feeding well, clingy and not interacting as the parents say is normal. Rousable, moving all limbs.',
        presentationU3:'Hot and flushed, whimpering and inconsolable, not feeding well, clingy and not interacting as the parents say is normal. Rousable, moving all limbs.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Hot and flushed, whimpering and inconsolable, not feeding well, clingy and not interacting normally, rousable and moving all limbs.', medications:'Nil.', pmh:'Nil.' },
        events:'Off form and hot since this morning, not taking feeds. Parent present and giving history.' },
      { cause:'febrile child, drowsy (sepsis-fork cue)', conscious:true, minAge:1, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT who is feverish and very sleepy.',
        presentation:'Hot and flushed, drowsy and quiet, harder to engage than expected, breathing fast, looks unwell.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Hot and flushed, drowsy and quiet, harder to engage than expected, breathing fast, looks unwell.', medications:'Nil.', pmh:'Nil.' },
        events:'Feverish and increasingly sleepy over the last several hours. Parent present.' },
    ],
    painBased: false,
    deviations: { hr:{ dir:'up', intensity:0.35 }, rr:{ dir:'up', intensity:0.3 }, temp:[38.6,40.0] },
    sample: {
      symptoms:'Child with an elevated temperature; degree of distress and alertness varies.',
      medications:'Usually nil regular.',
      pmh:'Usually nil of note.',
      lastIntake:'May be feeding or drinking less while unwell.',
    },
    opqrst: {
      onset:'Hot and unwell over the last several hours.',
      provocation:'No.',
      quality:'Feverish, hot and miserable.',
      radiates:'No.',
      severity:'0',
      time:'Over the last several hours.',
    },
    reveal: {
      diagnosis:'Paediatric pyrexia (elevated temperature). The key decision is recognising the unwell or septic child and not missing the sepsis fork.',
      pathway:'Remove or protect from a hot environment. If alert, offer cool fluids to drink. If not alert, recovery position and check blood glucose. Cool the patient. If temperature is over 38.5 degrees with distress or pain, give an antipyretic. If sepsis is queried, go to the Sepsis pathway. Otherwise SpO2 and ECG monitoring and transport.',
      interventions:'This is mostly recognition and supportive care: cooling, fluids if alert, antipyretic if distressed and febrile, and a low threshold for the sepsis pathway. The teaching value is spotting the child who is more than just febrile.',
      diagnosisBlocks: [
        { type:'lead', body:'Paediatric pyrexia, the priority is recognising the septic or seriously unwell child.' },
        { type:'note', body:'A drowsy, poorly perfused or rash-developing febrile child belongs on the Sepsis pathway.' },
      ],
      pathwayBlocks: [
        { type:'step', body:'Remove or protect from a hot environment. Cool the patient.' },
        { type:'branch', label:'Alert', body:'Offer cool fluids to drink.' },
        { type:'branch', label:'Not alert', body:'Recovery position and check blood glucose.' },
        { type:'branch', label:'Over 38.5 with distress or pain', body:'Give an antipyretic (paracetamol).' },
        { type:'note', body:'Query sepsis: go to the Sepsis pathway. Otherwise SpO2 and ECG monitoring, transport.' },
      ],
      interventionsBlocks: [
        { type:'lead', body:'Mostly recognition and supportive care.' },
        { type:'step', body:'Cool, fluids if alert, antipyretic if distressed and febrile, low threshold for sepsis.' },
      ],
      drugs: [
        { name:'Paracetamol',
          paed:{ paramedic:{ lead:'15 mg/kg PO.', route:'Or PR (Paramedic)', bands:[['>1 mth\u2013<1 yr','90 mg'],['1\u20133 yrs','180 mg'],['4\u20138 yrs','360 mg']] } } },
        { name:'Oxygen',
          paed:{ paramedic:'As required to maintain oxygenation.' } },
      ],
    },
  ...
  {
    id: 'sepsisPaed',
    name: 'Sepsis (Paediatric)',
    category: 'Infectious',
    demographics: { minAge: 1, maxAge: 12, sex: 'any' },
    variants: [
      { cause:'septic child, chest source', conscious:true, minAge:1, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT who is generally unwell with a suspected infection.',
        presentation:'Febrile and flushed, breathing fast with crackles at one base, working harder to breathe, looks unwell and tired, capillary refill a little prolonged.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Febrile and flushed, breathing fast, crackles at one base, increased work of breathing, looks unwell and tired, capillary refill a little prolonged.', medications:'Nil regular.', pmh:'Nil of note.' },
        events:'Chesty and feverish for a couple of days, now much worse and breathing fast. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.5 }, rr:{ dir:'up', intensity:0.5 }, spo2:[90,95], temp:[38.6,40.0] } },
      { cause:'septic child, meningococcal picture', conscious:true, minAge:1, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT who is very unwell with a rash.',
        presentation:'Febrile and very unwell, drowsy and irritable, photophobic, a non-blanching rash is appearing, mottled with prolonged capillary refill.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Febrile and very unwell, drowsy and irritable, photophobic, non-blanching rash appearing, mottled with prolonged capillary refill.', medications:'Nil.', pmh:'Nil.' },
        events:'Rapidly more unwell over a few hours with fever, drowsiness and a rash appearing. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.55 }, rr:{ dir:'up', intensity:0.45 }, temp:[38.8,40.2] } },
      { cause:'septic infant, high-risk by age', conscious:true, minAge:1, maxAge:2,
        dispatch:'You are called to {location} for a PATIENT who is floppy and not feeding.',
        presentation:'Floppy and lethargic, feeding poorly, mottled skin with prolonged capillary refill, not interacting as normal. Rousable. May feel hot or cold to touch.',
        presentationU3:'Floppy and lethargic, feeding poorly, mottled skin with prolonged capillary refill, not interacting as the parents say is normal. Rousable. May feel hot or cold to touch.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Floppy and lethargic, feeding poorly, mottled skin with prolonged capillary refill, not interacting normally, rousable, may feel hot or cold.', medications:'Nil.', pmh:'Nil.' },
        events:'Off feeds and floppy since today, parents very concerned. Parent present and giving history.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.5 }, rr:{ dir:'up', intensity:0.4 }, temp:[37.8,39.5] } },
      { cause:'at-risk / immunocompromised child (may be afebrile)', conscious:true, minAge:2, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT who is generally unwell and weak.',
        presentation:'Generally unwell, weak and clammy, looking worse than the basic obs first suggest, not obviously febrile, capillary refill prolonged.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Generally unwell, weak and clammy, looks worse than the basic obs suggest, not obviously febrile, capillary refill prolonged.', medications:'On treatment that lowers the immune system (per parent).', pmh:'An ongoing condition that affects the immune system.' },
        events:'Known to be at higher risk of infection, steadily and worryingly more unwell. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.5 }, rr:{ dir:'up', intensity:0.35 }, bpSys:[78,96], temp:[35.6,37.0] } },
    ],
    painBased: false,
    deviations: { hr:{ dir:'up', intensity:0.5 }, rr:{ dir:'up', intensity:0.4 }, temp:[38.6,40.0] },
    sample: {
      symptoms:'Generally unwell child with a suspected infection; findings and red/amber flags depend on the source.',
      medications:'Usually nil; immunosuppression raises the risk.',
      pmh:'Varies; risk factors include immunocompromise, age under 3 months, chronic disease.',
      lastIntake:'Often feeding or drinking poorly while unwell.',
    },
    opqrst: {
      onset:'Unwell over hours to a couple of days.',
      provocation:'No.',
      quality:'Generally and increasingly unwell.',
      radiates:'No.',
      severity:'0',
      time:'Hours to a day or two of getting worse.',
    },
    reveal: {
      diagnosis:'Paediatric sepsis, a child with a suspected infection and one or more red or amber flags, with or without risk factors. Recognition is the priority. The infant under 3 months and the immunocompromised child are high-risk even when not obviously febrile.',
      pathway:'Assess against the red and amber flags and the risk factors. Titrate SpO2 to at least 94 percent, give oxygen if there is inadequate perfusion, and request ALS. Give an antipyretic if the temperature is over 38.5 degrees. Fluids and antibiotic are Advanced Paramedic scope. Pre-alert ED for sepsis, septic shock, suspected meningitis, or risk of neutropenia.',
      interventions:'The teaching value is recognition: the red and amber flags, the risk factors, and the high-risk infant and immunocompromised child. Supportive care (oxygen, antipyretic) is within Paramedic and EMT scope; fluids, antibiotics and adrenaline for septic shock are Advanced Paramedic.',
      diagnosisBlocks: [
        { type:'lead', body:'Paediatric sepsis: suspected infection with red or amber flags, with or without risk factors.' },
        { type:'note', body:'Red flags: altered mental status (P or U on AVPU), inappropriate tachycardia, prolonged central capillary refill, non-blanching rash, hypotension, clinical deterioration.' },
        { type:'note', body:'Amber flags: inappropriate tachypnoea, altered functional status, practitioner or parental concern, vital signs deterioration.' },
        { type:'note', body:'Risk factors: immunocompromised, age under 3 months, chronic disease, recent surgery, break in skin (including chickenpox), indwelling line or device, signs of wound infection, incomplete vaccination.' },
      ],
      pathwayBlocks: [
        { type:'step', body:'Assess against red and amber flags and risk factors. Titrate SpO2 at least 94 percent, oxygen if inadequate perfusion, request ALS.' },
        { type:'branch', label:'Temperature over 38.5', body:'Give an antipyretic (paracetamol).' },
        { type:'branch', label:'Inadequate perfusion / shock', body:'Fluids (AP). Antibiotic (AP). Adrenaline for septic shock unresponsive to fluids (AP).' },
        { type:'note', body:'Pre-alert ED for sepsis, septic shock, suspected meningitis, or risk of neutropenia.' },
      ],
      interventionsBlocks: [
        { type:'lead', body:'Recognition first: flags, risk factors, the high-risk infant and immunocompromised child.' },
        { type:'note', body:'Supportive care (oxygen, antipyretic) is EMT/Paramedic. Fluids, antibiotics and adrenaline for septic shock are Advanced Paramedic.' },
      ],
      drugs: [
        { name:'Paracetamol (if temp over 38.5)',
          paed:{ paramedic:{ lead:'15 mg/kg PO.', route:'PR (Paramedic)', bands:[['>1 mth\u2013<1 yr','90 mg'],['1\u20133 yrs','180 mg'],['4\u20138 yrs','360 mg']] },
                 ap:{ route:'IV', bands:[['\u22641 yr','7.5 mg/kg'],['>1 yr','15 mg/kg']] } } },
        { name:'Sodium Chloride 0.9% (fluids)',
          paed:{ ap:'20 mL/kg IV/IO, repeat PRN. Advanced Paramedic scope only.' } },
        { name:'Ceftriaxone',
          paed:{ ap:{ route:'IV/IO/IM', bands:[['1 month\u201311 yrs','50 mg/kg'],['>11 yrs','2g']], note:'Advanced Paramedic scope.' } } },
        { name:'Adrenaline (septic shock unresponsive to fluids)',
          paed:{ ap:'0.1 mcg/kg IV/IO, repeat PRN. Advanced Paramedic scope.' } },
        { name:'Oxygen',
          paed:{ paramedic:'Titrate SpO2 to at least 94 percent.' } },
      ],
    },
  },
  ...
  {
    id: 'stridorPaed',
    name: 'Stridor / Croup (Paediatric)',
    category: 'Respiratory',
    demographics: { minAge: 1, maxAge: 6, sex: 'any' },
    variants: [
      { cause:'mild croup', conscious:true, minAge:1, maxAge:6,
        dispatch:'You are called to {location} for a PATIENT with a barking cough and noisy breathing.',
        presentation:'Barking cough, hoarse voice, stridor only when active or upset, settled and comfortable at rest with no recession at rest. Alert and interactive.',
        presentationU3:'Barking cough, hoarse cry, stridor only when active or upset, settled and comfortable at rest with no recession at rest. Alert and interactive.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Barking cough, hoarse voice, stridor only when active or upset, settled at rest, no recession at rest, alert and interactive.', medications:'Nil.', pmh:'Had a cold the last day or two.' },
        events:'Barking cough and noisy breathing, worse overnight, settles when calm. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.15 }, rr:{ dir:'up', intensity:0.2 }, spo2:[95,99] } },
      { cause:'moderate croup', conscious:true, minAge:1, maxAge:6,
        dispatch:'You are called to {location} for a PATIENT with noisy breathing at rest.',
        presentation:'Barking cough, intermittent stridor at rest, intermittent mild agitation, moderate chest wall retraction, breathing faster than normal. Alert.',
        presentationU3:'Barking cough, intermittent stridor at rest, intermittent mild agitation, moderate chest wall retraction, breathing faster than normal. Alert.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Barking cough, intermittent stridor at rest, intermittent mild agitation, moderate chest wall retraction, breathing faster than normal, alert.', medications:'Nil.', pmh:'Had a cold the last day or two.' },
        events:'Noisy, barking breathing for a day, now stridor even at rest. Parent present and keeping the child calm.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.35 }, rr:{ dir:'up', intensity:0.4 }, spo2:[93,97] } },
      { cause:'severe croup', conscious:true, minAge:1, maxAge:6,
        dispatch:'You are called to {location} for a PATIENT with severe noisy breathing and distress.',
        presentation:'Persistent stridor at rest, marked chest wall retraction, increasingly agitated then drowsy, marked increased or tiring respiratory effort, pale or dusky. Distressed by interference.',
        presentationU3:'Persistent stridor at rest, marked chest wall retraction, increasingly agitated then drowsy, marked increased or tiring respiratory effort, pale or dusky. Distressed by interference.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Persistent stridor at rest, marked chest wall retraction, agitated then drowsy, marked increased or tiring respiratory effort, pale or dusky, distressed by interference.', medications:'Nil.', pmh:'Had a cold the last day or two.' },
        events:'Worsening noisy breathing and distress; now stridor and recession at rest, not settling. Parent present and anxious.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.5 }, rr:{ dir:'up', intensity:0.5 }, spo2:[88,93] } },
    ],
    painBased: false,
    deviations: { hr:{ dir:'up', intensity:0.35 }, rr:{ dir:'up', intensity:0.4 }, spo2:[92,97] },
    sample: {
      symptoms:'Stridor and barking cough; severity ranges from stridor on exertion only to persistent stridor at rest with distress.',
      medications:'Usually nil.',
      pmh:'Often a recent coryzal illness.',
      lastIntake:'May be feeding less while unwell.',
    },
    opqrst: {
      onset:'Barking cough and noisy breathing, often worse overnight.',
      provocation:'Worse when upset or active; better when calm.',
      quality:'Barking cough with stridor.',
      radiates:'No.',
      severity:'0',
      time:'Over the last day or two, worse overnight.',
    },
    reveal: {
      diagnosis:'Paediatric stridor, most commonly croup (laryngotracheobronchitis). Grade mild, moderate or severe. The critical differential is epiglottitis: a drooling, toxic, tripod-positioned child who looks very unwell, do NOT examine the throat or put anything in the mouth, keep them calm and undisturbed.',
      pathway:'Consider foreign body airway obstruction. Do not distress the child; treat and transport in a position of comfort, ideally on the parent\u2019s lap. Oxygen, humidified if tolerated, ECG and SpO2 monitoring. Mild or moderate croup: dexamethasone PO. Severe croup: nebulised adrenaline (age-banded) plus dexamethasone PO. If febrile and septic, go to the Sepsis pathway.',
      interventions:'The priority is recognition and not distressing the child. Steroid for croup; nebulised adrenaline for severe croup. The dangerous mimic is epiglottitis, do not instrument the airway.',
      diagnosisBlocks: [
        { type:'lead', body:'Paediatric stridor, most commonly croup. Grade mild, moderate, severe.' },
        { type:'note', body:'Epiglottitis is the dangerous differential: drooling, toxic, tripod-positioned, very unwell. Do NOT examine the throat or put anything in the mouth. Keep calm and undisturbed.' },
      ],
      pathwayBlocks: [
        { type:'step', body:'Consider FBAO. Do not distress the child. Position of comfort, ideally on the parent\u2019s lap. Oxygen (humidified if tolerated), ECG and SpO2 monitoring.' },
        { type:'branch', label:'Mild / moderate croup', body:'Dexamethasone 300mcg/kg PO.' },
        { type:'branch', label:'Severe croup', body:'Nebulised adrenaline (age-banded) plus dexamethasone 300mcg/kg PO. May repeat adrenaline after 30 minutes PRN.' },
        { type:'note', body:'If febrile and septic, go to the Sepsis pathway.' },
      ],
      interventionsBlocks: [
        { type:'lead', body:'Recognition and not distressing the child are the priority.' },
        { type:'note', body:'Do not insert anything into the mouth in suspected epiglottitis or severe croup (other than PO medications for croup). Agitation can precipitate complete airway obstruction.' },
      ],
      drugs: [
        { name:'Adrenaline NEB (severe croup)',
          paed:{ paramedic:{ route:'NEB (severe croup)', bands:[['<1 yr','2.5mg'],['\u22651 yr','5mg']], note:'May repeat after 30 minutes PRN.' } } },
        { name:'Dexamethasone',
          paed:{ paramedic:'300mcg/kg PO. Maximum 600mcg/kg in any 72 hours.' } },
        { name:'Oxygen',
          paed:{ paramedic:'Humidified, as high a concentration as tolerated.' } },
      ],
    },
  },

  {
    id: 'shockBloodLossPaed',
    name: 'Shock from Blood Loss (Paediatric)',
    category: 'Trauma',
    demographics: { minAge: 3, maxAge: 12, sex: 'any' },
    variants: [
      { cause:'compensated shock post-trauma', conscious:true, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT injured and looking unwell.',
        presentation:'After injury: tachycardic, breathing faster than normal but without increased effort, cool peripheries, prolonged capillary refill, but alert and maintaining blood pressure. Looks pale.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'After injury: tachycardic, breathing faster than normal but without increased effort, cool peripheries, prolonged capillary refill, alert and maintaining BP, pale.', medications:'Nil.', pmh:'Nil of note.' },
        opqrst:{ onset:'At the time of the injury.', provocation:'Injury pain.', quality:'Injured and unwell.', radiates:'No.', severity:'5', time:'Since the injury.' },
        events:'Significant trauma such as a road traffic collision or fall; concerning mechanism. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.45 }, rr:{ dir:'up', intensity:0.3 } } },
      { cause:'decompensated shock', conscious:true, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a critically injured PATIENT.',
        presentation:'Pale and mottled, cool extremities, weak or absent peripheral pulses, prolonged capillary refill, irritable then drowsy, tachycardic, breathing fast. Hypotension is a late sign.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Pale and mottled, cool extremities, weak or absent peripheral pulses, prolonged capillary refill, irritable then drowsy, tachycardic, breathing fast.', medications:'Nil.', pmh:'Nil of note.' },
        opqrst:{ onset:'At the time of the injury.', provocation:'Severe injury.', quality:'Critically injured and shocked.', radiates:'No.', severity:'8', time:'Since the injury, deteriorating.' },
        events:'Major trauma with suspected internal bleeding. Parent present and distressed.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.6 }, rr:{ dir:'up', intensity:0.5 }, bpSys:[70,88] } },
      { cause:'internal haemorrhage, deteriorating', conscious:true, minAge:3, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT with abdominal injury.',
        presentation:'Abdominal or pelvic injury, distended tender abdomen, pale and clammy, tachycardic, prolonged capillary refill, becoming agitated.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Abdominal or pelvic injury, distended tender abdomen, pale and clammy, tachycardic, prolonged capillary refill, becoming agitated.', medications:'Nil.', pmh:'Nil of note.' },
        opqrst:{ onset:'At the time of the injury.', provocation:'Abdomen tender.', quality:'Deep abdominal pain after blunt trauma.', radiates:'Across the abdomen.', severity:'7', time:'Since the injury, worsening.' },
        events:'Blunt abdominal trauma with suspected internal haemorrhage. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.55 }, rr:{ dir:'up', intensity:0.4 }, bpSys:[76,94] } },
    ],
    painBased: true,
    deviations: { hr:{ dir:'up', intensity:0.5 }, rr:{ dir:'up', intensity:0.4 }, bpSys:[80,98] },
    sample: {
      symptoms:'Shock following trauma; recognise the perfusion signs before hypotension, which is a late sign in children.',
      medications:'Usually nil.',
      pmh:'Usually nil of note.',
      lastIntake:'Variable.',
    },
    opqrst: {
      onset:'At the time of the trauma.',
      provocation:'Injury and movement.',
      quality:'Injured and shocked.',
      radiates:'No.',
      severity:'6',
      time:'Since the injury.',
    },
    reveal: {
      diagnosis:'Paediatric shock from blood loss (trauma). Children compensate then crash: recognise the perfusion signs (tachycardia, prolonged capillary refill, mottling, cool extremities, irritability then altered consciousness) before hypotension, which is a late and ominous sign.',
      pathway:'Control external haemorrhage, oxygen, request ALS. If clinical signs of shock: NaCl 0.9% 10mL/kg IV/IO (AP). If significant internal or external haemorrhage is suspected: tranexamic acid 15mg/kg IV/IO in 100mL NaCl (AP), reassess, then NaCl 0.9% 10mL/kg IV/IO aliquots if signs of inadequate perfusion. Maintain normo-temperature. Continue fluid therapy to handover at ED.',
      interventions:'Recognition is the priority: the perfusion signs (A-E), the compensated-then-decompensated pattern. Haemorrhage control is mechanical and within all scopes; fluids and tranexamic acid are Advanced Paramedic.',
      diagnosisBlocks: [
        { type:'lead', body:'Paediatric shock from blood loss after trauma. Children compensate then crash.' },
        { type:'note', body:'Signs of inadequate perfusion: increased respiratory rate without increased effort; tachycardia, diminished or absent peripheral pulses, delayed capillary refill; irritability, confusion or altered consciousness; cool extremities, mottling. Hypotension is a late sign.' },
      ],
      pathwayBlocks: [
        { type:'step', body:'Control external haemorrhage. Oxygen. Request ALS.' },
        { type:'branch', label:'Clinical signs of shock', body:'NaCl 0.9% 10mL/kg IV/IO (AP).' },
        { type:'branch', label:'Suspected significant haemorrhage', body:'Tranexamic acid 15mg/kg IV/IO in 100mL NaCl (AP). Reassess. NaCl 0.9% 10mL/kg IV/IO aliquots if inadequate perfusion.' },
        { type:'note', body:'Maintain normo-temperature. Continue fluid therapy to handover at ED.' },
      ],
      interventionsBlocks: [
        { type:'lead', body:'Recognition of the perfusion signs is the priority.' },
        { type:'note', body:'Haemorrhage control is mechanical (all scopes). Fluids and tranexamic acid are Advanced Paramedic.' },
      ],
      drugs: [
        { name:'Sodium Chloride 0.9% IV/IO',
          paed:{ ap:'10mL/kg, aliquots if inadequate perfusion. Advanced Paramedic scope only.' } },
        { name:'Tranexamic acid',
          paed:{ ap:'15mg/kg IV/IO in 100mL NaCl. Advanced Paramedic scope only.' } },
        { name:'Oxygen',
          paed:{ paramedic:'As required.' } },
      ],
    },
  },
  ...
  {
    id: 'bradycardiaPaed',
    name: 'Symptomatic Bradycardia (Paediatric)',
    category: 'Resuscitation',
    demographics: { minAge: 1, maxAge: 12, sex: 'any' },
    variants: [
      { cause:'symptomatic bradycardia, poor perfusion', conscious:true, minAge:1, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT who is floppy and unwell.',
        presentation:'Slow heart rate, pale and mottled, cool extremities, prolonged capillary refill, drowsy and poorly responsive, breathing inadequately with poor effort or fast shallow breaths.',
        presentationU3:'Slow heart rate, pale and mottled, cool extremities, prolonged capillary refill, floppy and poorly responsive, breathing inadequately with poor effort.',
        allergies:'Unknown.',
        sample:{ symptoms:'Slow heart rate, pale and mottled, cool extremities, prolonged capillary refill, drowsy and poorly responsive, breathing inadequately.', medications:'Nil known (per parent).', pmh:'Nil known (per parent).' },
        events:'Became increasingly unwell, floppy and slow; often a hypoxic or respiratory cause. Parent present and distressed.',
        vitalsOverride:{ hr:{ dir:'down', intensity:0.6, floor:[{age:1,val:50},{age:12,val:45}] }, rr:{ dir:'up', intensity:0.3 }, spo2:[84,92] } },
    ],
    painBased: false,
    deviations: { hr:{ dir:'down', intensity:0.55, floor:50 }, spo2:[86,93] },
    sample: {
      symptoms:'Bradycardia with signs of inadequate perfusion in a child; usually a hypoxic or respiratory cause.',
      medications:'Usually nil known.',
      pmh:'Usually nil known.',
      lastIntake:'Per parent.',
    },
    opqrst: {
      onset:'Became unwell and slow over a period.',
      provocation:'No.',
      quality:'Floppy, slow and poorly responsive.',
      radiates:'No.',
      severity:'0',
      time:'Over a period of becoming unwell.',
    },
    reveal: {
      diagnosis:'Paediatric symptomatic bradycardia: a heart rate under 60 with signs of inadequate perfusion. In children this is usually secondary to hypoxia or respiratory failure, so it is treated like an arrest (oxygenate, ventilate, compress).',
      pathway:'Oxygen. If hypoxic, positive pressure ventilation 12 to 20 per minute. If HR under 60 with inadequate perfusion and unresponsive: CPR. NaCl 0.9% 20 mL/kg IV/IO. Adrenaline (1:10,000) 10 mcg/kg IV/IO, repeat every 3 to 5 minutes PRN. The key teaching: paediatric bradycardia with poor perfusion is a peri-arrest emergency treated like arrest.',
      interventions:'Collective signs of inadequate perfusion: tachypnoea, diminished or absent peripheral pulses, delayed capillary refill, cool extremities and mottling, unresponsive. Oxygenate and ventilate first; compress if HR under 60 with poor perfusion.',
      diagnosisBlocks: [
        { type:'lead', body:'Paediatric symptomatic bradycardia: HR under 60 with inadequate perfusion. Usually a hypoxic or respiratory cause.' },
      ...
      drugs: [
        { name:'Adrenaline (1:10,000)',
          paed:{ ap:'10 mcg/kg IV/IO, repeat every 3 to 5 minutes PRN. Advanced Paramedic scope.' } },
        { name:'Sodium Chloride 0.9% IV/IO',
          paed:{ ap:'20 mL/kg IV/IO. Advanced Paramedic scope.' } },
        { name:'Oxygen / Ventilation',
          paed:{ paramedic:'Oxygen; positive pressure ventilation 12 to 20 per minute if hypoxic.' } },
      ],
    },
  },
  ...
  {
    id: 'abnormalWobPaed',
    name: 'Abnormal Work of Breathing (Paediatric)',
    category: 'Respiratory',
    demographics: { minAge: 1, maxAge: 12, sex: 'any' },
    variants: [
      { cause:'undifferentiated respiratory distress', conscious:true, minAge:1, maxAge:15,
        dispatch:'You are called to {location} for a PATIENT who is working hard to breathe.',
        presentation:'Increased work of breathing, fast respiratory rate, recession and accessory muscle use, looks distressed. The cause is not yet clear.',
        presentationU3:'Increased work of breathing, fast respiratory rate, recession and accessory muscle use, looks distressed and unsettled. The cause is not yet clear.',
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Increased work of breathing, fast respiratory rate, recession and accessory muscle use, distressed.', medications:'Nil known (per parent).', pmh:'Nil known (per parent).' },
        events:'Became breathless and is working hard to breathe. Parent present.',
        vitalsOverride:{ hr:{ dir:'up', intensity:0.4 }, rr:{ dir:'up', intensity:0.5 }, spo2:[90,95] } },
    ],
    painBased: false,
    deviations: { hr:{ dir:'up', intensity:0.4 }, rr:{ dir:'up', intensity:0.45 }, spo2:[91,96] },
    sample: {
      symptoms:'Increased work of breathing in a child; the underlying cause needs to be identified.',
      medications:'Usually nil known.',
      pmh:'Usually nil known.',
      lastIntake:'Per parent.',
    },
    opqrst: {
      onset:'Breathlessness over a period.',
      provocation:'Varies with the cause.',
      quality:'Working hard to breathe.',
      radiates:'No.',
      severity:'0',
      time:'Over a period.',
    },
    reveal: {
      diagnosis:'Abnormal work of breathing is a triage presentation, not a single diagnosis. The task is to recognise the increased work of breathing, assess airway, breathing and circulation, and identify which pathway the child belongs on.',
      pathway:'Assess and support airway, breathing and oxygenation. Then branch by the likely cause: bronchospasm and wheeze go to the Asthma pathway; stridor goes to the Stridor or Croup pathway; swelling, urticaria and a trigger go to the Anaphylaxis pathway; fever with a sick child goes to the Sepsis pathway; a reduced conscious level with pinpoint pupils or a substance history suggests opioid toxicity (naloxone). Treat life threats as you find them.',
      interventions:'The teaching point is the assessment and the branch decision. Oxygenate and support breathing first, then route to the correct pathway. The one drug specific to this CPG is naloxone, for the substance-intake or opioid-toxicity branch.',
      diagnosisBlocks: [
        { type:'lead', body:'Abnormal work of breathing is a triage presentation, not a single diagnosis.' },
        { type:'note', body:'Recognise the increased work of breathing, assess A-B-C, identify the pathway: brain insult, respiratory failure, substance intake, bronchospasm, or another cause.' },
      ],
      pathwayBlocks: [
        { type:'step', body:'Support airway, breathing and oxygenation first. Treat life threats as you find them.' },
        { type:'branch', label:'Wheeze / bronchospasm', body:'Asthma pathway.' },
        { type:'branch', label:'Stridor', body:'Stridor / Croup pathway.' },
        { type:'branch', label:'Swelling, urticaria, trigger', body:'Anaphylaxis pathway.' },
        { type:'branch', label:'Fever, sick child', body:'Sepsis pathway.' },
        { type:'branch', label:'Reduced consciousness, opioid history', body:'Naloxone.' },
      ],
      interventionsBlocks: [
        { type:'lead', body:'Assess and branch. Oxygenate and support breathing, then route to the correct pathway.' },
        { type:'note', body:'Naloxone is the one drug specific to this CPG, for the opioid-toxicity branch.' },
      ],
      drugs: [
        { name:'Naloxone (opioid toxicity branch)',
          paed:{ paramedic:'10 mcg/kg IV/IO/IM/SC, or 20 mcg/kg IN. Repeat PRN to a maximum of 100 mcg/kg or 2mg.' } },
        { name:'Oxygen / Ventilation',
          paed:{ paramedic:'Oxygen; support breathing. Positive pressure ventilation if inadequate.' } },
      ],
    },
  },
