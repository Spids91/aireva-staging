...
const PRESENTATIONS = [
  {
    ...
    variants: [
      ...
      { cause:'paed mild allergic reaction', conscious:true, minAge:1, maxAge:12,
      ...
      { cause:'paed moderate reaction', conscious:true, minAge:1, maxAge:12,
      ...
      { cause:'paed severe anaphylaxis', conscious:true, minAge:1, maxAge:12,
      ...
      { cause:'paed anaphylaxis with shock', conscious:true, minAge:1, maxAge:12,
...

  {
    ...
    variants: [
      ...
      { cause:'paed T1DM, conscious', conscious:true, minAge:3, maxAge:12,
      ...
      { cause:'paed T1DM after activity, conscious', conscious:true, minAge:5, maxAge:12,
        dispatch:'You are called to {location} for a PATIENT who has gone pale and shaky.',
      ...
      { cause:'paed reduced consciousness, unable to swallow', conscious:false, minAge:2, maxAge:12,
        dispatch:'You are called to {location} for a PATIENT who cannot be roused.',
        presentation:'Deeply drowsy, responds only to a painful stimulus with a groan, profusely sweaty with cold clammy skin, breathing on their own. NOT able to swallow or protect their own airway.',
        allergies:'No known drug allergies.',
...

  {
    ...
    variants: [
      ...
      { cause:'paed scald, small superficial', conscious:true, minAge:1, maxAge:12,
      ...
      { cause:'paed scald, larger area', conscious:true, minAge:1, maxAge:12,
      ...
      { cause:'paed flame burn with inhalation concern', conscious:true, minAge:3, maxAge:12,
      ...
      { cause:'paed large burn, severe', conscious:true, minAge:3, maxAge:12,
        dispatch:'You are called to {location} for a critically injured PATIENT.',
    ...
    reveal: {
      ...
      drugs: [
        ...
        { name:'NaCl 0.9% (fluids)',
          ...
          paed:{ ap:'If >10% TBSA and/or >1 hour from injury to ED: 5\\u201310 yrs 250mL IV/IO; >10 yrs 500mL IV/IO.' } },
      ],
    },
  },
  ...
  },
  {
    ...
    variants: [
      ...
      { cause:'paed known epilepsy, postictal', conscious:true, minAge:3, maxAge:12, witness:'witnessed', onsetWhen:'about 15 minutes ago',
        ...
        vitalsOverride:{ hr:{ dir:'up', intensity:0.35 } } },
      { cause:'paed prolonged active seizure', conscious:false, minAge:1, maxAge:12, witness:'witnessed',
        dispatch:'You are called to {location} for a PATIENT who is fitting.',
      ...
      { cause:'paed recurrent seizures without recovery', conscious:false, minAge:1, maxAge:12, witness:'witnessed',
        dispatch:'You are called to {location} for a PATIENT having repeated fits.',
    ...
    reveal: {
      ...
      drugs: [
        { name:'Midazolam (actively seizing)',
          ...
          paed:{ paramedic:'Buccal: <3 mths 0.3mg/kg (max 2.5mg); 3 mths\\u2013<1 yr 2.5mg; 1\\u2013<5 yrs 5mg; 5\\u2013<10 yrs 7.5mg; \\u226510 yrs 10mg. Or IN 200mcg/kg.', ap:'IV/IO: 100mcg/kg.' } },
        { name:'Diazepam (actively seizing)',
          adult:{ paramedic:'Not in Paramedic scope.', ap:'10mg PR, or 5mg IV/IO.' },
          paed:{ paramedic:'Not in Paramedic scope.', ap:'IV/IO: 100mcg/kg. Or PR: \\u22651 mth\\u2013<2 yrs 5mg; \\u22652\\u2013<12 yrs 5\\u201310mg; \\u226512 yrs 10mg.' } },
...

  {
    ...
    variants: [
      ...
      { cause:'paed controlled bleed', conscious:true, minAge:3, maxAge:12,
        ...
        vitalsOverride:{ hr:{ dir:'up', intensity:0.3 } } },
      { cause:'paed catastrophic limb haemorrhage', conscious:true, minAge:3, maxAge:12,
      ...
      { cause:'paed haemorrhage requiring escalation', conscious:true, minAge:3, maxAge:12,
        ...
        vitalsOverride:{ hr:{ dir:'up', intensity:0.45 } } },
      { cause:'paed major haemorrhage with shock', conscious:false, minAge:3, maxAge:12,
        dispatch:'You are called to {location} for a PATIENT who has collapsed and is bleeding heavily.',
...

  {
    ...
    variants: [
      ...
      { cause:'paed arrest, BLS entry', conscious:false, witness:'witnessed', minAge:1, maxAge:12, arrestRhythm:'Not yet determined (pads being attached)',
      ...
      { cause:'paed arrest, VF or pulseless VT', conscious:false, witness:'witnessed', minAge:1, maxAge:12, arrestRhythm:'VF / pulseless VT (shockable)',
        dispatch:'You are called to {location} for a PATIENT who has collapsed and is unresponsive.',
      ...
      { cause:'paed arrest, asystole or PEA', conscious:false, witness:'witnessed', minAge:1, maxAge:12, arrestRhythm:'Asystole / PEA (non-shockable)',
        dispatch:'You are called to {location} for a PATIENT who is unresponsive and not breathing.',
...

  {
    ...
    variants: [
      ...
      { cause:'paed mild asthma', conscious:true, minAge:3, maxAge:12,
        dispatch:'You are called to {location} for a PATIENT who is wheezy and short of breath.',
        ...
        vitalsOverride:{ hr:{ dir:'up', intensity:0.2 }, rr:{ dir:'up', intensity:0.25 }, spo2:[94,98] } },
      { cause:'paed moderate asthma', conscious:true, minAge:3, maxAge:12,
        dispatch:'You are called to {location} for a PATIENT struggling with their breathing.',
        ...
        vitalsOverride:{ hr:{ dir:'up', intensity:0.45 }, rr:{ dir:'up', intensity:0.5 }, spo2:[91,95] } },
      { cause:'paed severe asthma', conscious:true, minAge:3, maxAge:12,
        dispatch:'You are called to {location} for a PATIENT in severe respiratory distress.',
        ...
        vitalsOverride:{ hr:{ dir:'up', intensity:0.6 }, rr:{ dir:'up', intensity:0.6 }, spo2:[88,93] } },
      { cause:'paed life-threatening asthma', conscious:true, minAge:3, maxAge:12,
        dispatch:'You are called to {location} for a PATIENT who is barely breathing.',
        presentation:'Exhausted and barely able to speak, a silent chest on auscultation, cyanosed and drowsy, with poor respiratory effort.',
        allergies:'No known drug allergies.',
    ...
    reveal: {
      ...
      drugs: [
        { name:'Salbutamol (mainstay, Paramedic scope)',
          ...
          paed:{ paramedic:'NEB: <5 yrs 2.5mg; \\u22655 yrs 5mg. Or 100mcg metered aerosol, repeatable. Life-threatening: age-specific NEB every 5 minutes PRN.' } },
        { name:'Ipratropium + Salbutamol (Paramedic)',
          ...
          paed:{ paramedic:'Ipratropium NEB <12 yrs 250mcg; \\u226512 yrs 500mcg, mixed with age-specific Salbutamol. Moderate and worse.' } },
        { name:'Hydrocortisone (severe)',
          adult:{ ap:'100mg slow IV (infusion in 100mL NaCl 0.9%).' },
          paed:{ ap:'IV (in 100mL NaCl 0.9%): <1 yr 25mg; 1\\u20135 yrs 50mg; >5 yrs 100mg.' } },
...

  {
    ...
    variants: [
      ...
      { cause:'paed known Addisons, crisis, conscious', conscious:true, minAge:3, maxAge:12,
        dispatch:'You are called to {location} for a PATIENT who is vomiting and very weak.',
      ...
      { cause:'paed known Addisons, reduced consciousness', conscious:false, minAge:3, maxAge:12,
        dispatch:'You are called to {location} for a PATIENT who cannot be roused.',
    ...
    reveal: {
      ...
      drugs: [
        { name:'Hydrocortisone',
          ...
          paed:{ paramedic:'IM (consider if IV not available): 6 mth\\u2013\\u22645 yrs 50 mg; >5 yrs 100 mg.', ap:'IV (in 100 mL NaCl 0.9%): 6 mth\\u2013\\u22645 yrs 50 mg; >5 yrs 100 mg.' } },
...

  {
    ...
    variants: [
      ...
      { cause:'paed vaso-occlusive pain crisis', conscious:true, minAge:3, maxAge:12,
        dispatch:'You are called to {location} for a PATIENT in severe pain.',
        ...
        vitalsOverride:{ hr:{ dir:'up', intensity:0.4 } } },
      { cause:'paed sickle crisis with fever', conscious:true, minAge:3, maxAge:12,
      ...
      { cause:'paed sickle crisis with dehydration', conscious:true, minAge:3, maxAge:12,
...

  {
    ...
    variants: [
      ...
      { cause:'paed closed forearm fracture', conscious:true, minAge:3, maxAge:12,
        ...
        vitalsOverride:{ hr:{ dir:'up', intensity:0.35 } } },
      { cause:'paed femur fracture', conscious:true, minAge:3, maxAge:12,
        ...
        vitalsOverride:{ hr:{ dir:'up', intensity:0.45 } } },
      { cause:'paed open fracture', conscious:true, minAge:3, maxAge:12,
        ...
        vitalsOverride:{ hr:{ dir:'up', intensity:0.5 } } },
      { cause:'paed dislocation', conscious:true, minAge:6, maxAge:12,
    ...
    reveal: {
      ...
      drugs: [
        ...
        { name:'Ceftriaxone',
          ...
          paed:{ ap:'Open fracture (after removing gross contamination): 1 month\\u201311 yrs 50mg/kg IV/IO/IM; >11 yrs 2g IV/IO/IM. Advanced Paramedic scope.' } },
      ],
    },
  },
...

  {
    ...
    variants: [
      { cause:'febrile child, alert, distressed', conscious:true, minAge:3, maxAge:12,
      ...
      { cause:'febrile child, drowsy (sepsis-fork cue)', conscious:true, minAge:1, maxAge:12,
    ...
    reveal: {
      ...
      drugs: [
        { name:'Paracetamol',
          paed:{ paramedic:'15 mg/kg PO. Or PR (Paramedic): >1 mth\\u2013<1 yr 90 mg; 1\\u20133 yrs 180 mg; 4\\u20138 yrs 360 mg.' } },
        { name:'Oxygen',
          paed:{ paramedic:'As required to maintain oxygenation.' } },
      ],
    },
...

  {
    ...
    demographics: { minAge: 1, maxAge: 12, sex: 'any' },
    variants: [
      { cause:'septic child, chest source', conscious:true, minAge:1, maxAge:12,
        dispatch:'You are called to {location} for a PATIENT who is generally unwell with a suspected infection.',
      ...
      { cause:'septic child, meningococcal picture', conscious:true, minAge:1, maxAge:12,
      ...
      { cause:'at-risk / immunocompromised child (may be afebrile)', conscious:true, minAge:2, maxAge:12,
    ...
    reveal: {
      ...
      drugs: [
        { name:'Paracetamol (if temp over 38.5)',
          paed:{ paramedic:'15 mg/kg PO. PR (Paramedic): >1 mth\\u2013<1 yr 80 mg; 1\\u20133 yrs 180 mg; 4\\u20138 yrs 360 mg.', ap:'IV: \\u22641 yr 7.5 mg/kg; >1 yr 15 mg/kg.' } },
        { name:'Sodium Chloride 0.9% (fluids)',
          paed:{ ap:'20 mL/kg IV/IO, repeat PRN. Advanced Paramedic scope only.' } },
        { name:'Ceftriaxone',
          paed:{ ap:'1 month\\u201311 yrs 50 mg/kg IV/IO/IM; >11 yrs 2g IV/IO/IM. Advanced Paramedic scope.' } },
    ...
    reveal: {
      ...
      drugs: [
        { name:'Adrenaline NEB (severe croup)',
          paed:{ paramedic:'<1 yr 2.5mg NEB; \\u22651 yr 5mg NEB. May repeat after 30 minutes PRN.' } },
        { name:'Dexamethasone',
...

  {
    ...
    variants: [
      { cause:'compensated shock post-trauma', conscious:true, minAge:3, maxAge:12,
      ...
      { cause:'decompensated shock', conscious:true, minAge:3, maxAge:12,
        dispatch:'You are called to {location} for a critically injured PATIENT.',
      ...
      { cause:'internal haemorrhage, deteriorating', conscious:true, minAge:3, maxAge:12,
...

  {
    ...
    demographics: { minAge: 1, maxAge: 12, sex: 'any' },
    variants: [
      { cause:'symptomatic bradycardia, poor perfusion', conscious:true, minAge:1, maxAge:12,
...

  {
    ...
    demographics: { minAge: 1, maxAge: 12, sex: 'any' },
    variants: [
      { cause:'undifferentiated respiratory distress', conscious:true, minAge:1, maxAge:12,
