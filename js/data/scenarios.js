...
const PRESENTATIONS = [
...

  {
    ...
    variants: [
      ...
      { cause:'right-hemisphere stroke, left-sided weakness', conscious:true, witness:'witnessed',
        ...
        allergies:'No known drug allergies.',
        sample:{ medications:'Eliquis for atrial fibrillation, and Tritace for blood pressure.', pmh:'Atrial fibrillation and high blood pressure.', lastIntake:'Family were with them and saw them completely well about 40 minutes ago.' },
        events:'Was well, then suddenly developed a drooping face and a weak arm on the left side; onset time is known and recent.' },
      { cause:'left-hemisphere stroke, speech affected', conscious:true, witness:'witnessed',
        ...
        sample:{ medications:'Plavix, Lipitor, and Coversyl.', pmh:'A previous TIA two years ago, high cholesterol, and high blood pressure.', lastIntake:'A relative was present and noted the exact time the speech changed, about half an hour ago.' },
      ...
      { cause:'wake-up stroke, uncertain onset', conscious:true, witness:'witnessed',
        ...
        allergies:'No known drug allergies.',
        sample:{ medications:'A few tablets, a water tablet and something for diabetes, not sure of the names. The blister pack says Glucophage and Lasix.', pmh:'Type 2 diabetes and heart failure.', lastIntake:'Was seen well last night before bed; woke with the symptoms, so the exact onset overnight is unknown.' },
        events:'Went to bed well and woke with one-sided weakness; cannot say when within the night it started.' },
      { cause:'transient symptoms, resolving', conscious:true, witness:'witnessed',
        ...
        allergies:'No known drug allergies.',
        sample:{ medications:'Xarelto and Istin.', pmh:'Atrial fibrillation and high blood pressure.', lastIntake:'Family saw the symptoms start and improve over the last half hour.' },
      ...
      { cause:'posterior circulation stroke', conscious:true, witness:'unwitnessed',
        ...
        allergies:'No known drug allergies.',
        sample:{ medications:'Aspirin and Lipitor.', pmh:'High cholesterol; smoker.' },
      ...
      { cause:'large stroke, severe deficit', conscious:true, witness:'unwitnessed',
        ...
        allergies:'No known drug allergies.',
        sample:{ medications:'Marevan, Cardicor, Lasix, and Lanoxin.', pmh:'Atrial fibrillation, heart failure, and a previous stroke.' },
