...

  {
    ...
    variants: [
      ...
      { cause:'cold-triggered exacerbation', conscious:true, severity:0.4,
        ...
        allergies:'No known drug allergies.',
        sample:{ symptoms:'Acute wheeze and breathlessness with a prolonged expiratory phase, triggered by cold air.', medications:'Symbicort and Ventolin.', pmh:'COPD; current smoker.' },
